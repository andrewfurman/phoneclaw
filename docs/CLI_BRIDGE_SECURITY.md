...
- Keep CLI tools read-only by default. Any write tool must be narrowly scoped and confirmation-gated. Current email writes can archive messages and save drafts only; they cannot send email.
